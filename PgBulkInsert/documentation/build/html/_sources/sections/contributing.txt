...
PgBulkInsert is an open source project and there are many ways to contribute to it.  
...
The PgBulkInsert project is hosted on GitHub at:

* `https://github.com/bytefish/PgBulkInsert <https://github.com/bytefish/PgBulkInsert>`_

Want to get your hands on the sources? Then clone the repository using the following git command:

::

    git clone https://github.com/bytefish/PgBulkInsert
...
5. Navigate to one of the projects Documentation located at :code:`PgBulkInsert/documentation/`.
