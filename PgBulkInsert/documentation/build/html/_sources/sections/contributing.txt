...
JTinyCsvParser is an open source project and there are many ways to contribute to it.  
...
The JTinyCsvParser project is hosted on GitHub at:

* `https://github.com/bytefish/JTinyCsvParser <https://github.com/bytefish/JTinyCsvParser>`_

Want to get your hands on the sources? Then clone the repository using the following git command:

::

    git clone https://github.com/bytefish/JTinyCsvParser
...
5. Navigate to one of the projects Documentation located at :code:`JTinyCsvParser/documentation/`.
